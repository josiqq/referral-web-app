-- ============================================
-- Fix: Referral code field name mismatch
-- ============================================
-- Problem: Frontend sends 'referred_by_code' and 'full_name'
--          but trigger expected 'referral_code' and 'display_name'

-- Update the handle_new_user function to use correct field names
